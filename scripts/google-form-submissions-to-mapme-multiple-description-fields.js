    ...
    for (let j = 0; j < itemResponses.length; j++) {
        ...
        switch (title) {
            ...
            case 'Category':
                ...
                break
			case 'description2':
                description2 = response
                break
			case 'description3':
                description3 = response
                break
        }
    }
	const modifiedDesc = "<p>" + description + "</p><p>Description2: " + description2 + "</p><p>description3: " + description3 + "</p>"
    const body = createRequest(name, address, modifiedDesc, categories, websiteURL)
    Logger.log(body)
    const method = 'post'
